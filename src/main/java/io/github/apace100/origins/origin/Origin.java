...
public class Origin {
    ...
    private final Map<Identifier, Identifier> texture_map;


    public Origin(Identifier id, ItemStack icon, Impact impact, int order, int loadingPriority, Map<Identifier, Identifier> texture_map) {
        this.identifier = id;
    ...
    public SerializableData.Instance toData() {
        ...
        data.set("texture_map", texture_map);
