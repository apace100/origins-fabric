...
public class TargetActionOnHitPower extends CooldownPower {
    ...
    public TargetActionOnHitPower(PowerType<?> type, PlayerEntity player, int cooldownDuration, HudRender hudRender, Predicate<Pair<DamageSource, Float>> damageCondition, Consumer<Entity> entityAction) {
