...
public class BlockActions {
    ...
    public static void register() {
        ...
        register(new ActionFactory<>(Origins.identifier("choice"), new SerializableData()
            ...
            (data, block) -> {
                FilterableWeightedList<ActionFactory<Triple<World, BlockPos, Direction>>.Instance> actionList = data.get("actions");
    ...
    private static void register(ActionFactory<Triple<World, BlockPos, Direction>> actionFactory) {
        ModRegistries.BLOCK_ACTION.register(actionFactory.getSerializerId(), () -> actionFactory);
    }
}
